...
ImGuiStyle::ImGuiStyle()
{
    ...
    WindowMinSize           = ImVec2(10,10);    // Minimum window size
    WindowMaxSize           = ImVec2(1000, 500); 
...
void ImGuiStyle::ScaleAllSizes(float scale_factor)
{
    ...
    WindowMaxSize = ImFloor(WindowMaxSize * scale_factor);
...
static ImVec2 CalcWindowSizeAfterConstraint(ImGuiWindow* window, ImVec2 new_size)
{
    ...
    if (!(window->Flags & (ImGuiWindowFlags_ChildWindow | ImGuiWindowFlags_AlwaysAutoResize)))
    {
        ...
        new_size = ImMin(new_size, g.Style.WindowMaxSize);
...
static ImVec2 CalcWindowAutoFitSize(ImGuiWindow* window, const ImVec2& size_contents)
{
    ...
    else
    {
        ...
        ImVec2 size_max = style.WindowMaxSize;
        ...
        size_auto_fit = ImClamp(size_auto_fit, size_min, ImMin(size_max, g.IO.DisplaySize - style.DisplaySafeAreaPadding * 2.0f));
...
static const ImGuiStyleVarInfo GStyleVarInfo[] =
{
    ...
    { ImGuiDataType_Float, 2, (ImU32)IM_OFFSETOF(ImGuiStyle, WindowMaxSize) },       // ImGuiStyleVar_WindowMinSize
